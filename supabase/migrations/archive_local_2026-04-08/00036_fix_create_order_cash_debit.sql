-- ============================================================
-- DZpatch V2.0 — Fix create_order: skip wallet debit for cash orders
-- Migration: 00036_fix_create_order_cash_debit.sql
--
-- Root cause: create_order always called debit_wallet regardless of
-- payment method. Cash orders have no wallet balance to debit, so
-- the RPC threw an exception and no order row was ever created.
-- Fix: only debit wallet when p_payment_method = 'wallet'.
-- ============================================================
...
BEGIN
    ...
    -- Only debit wallet for wallet-payment orders
