-- ============================================================
-- DZpatch V2.0 — Definitive rewrite of create_order
-- Migration: 00022_rewrite_create_order_final.sql
--
-- Previous DO-block patches (00018, 00019, 00021) failed because
-- pg_get_functiondef returns intervals as '00:10:00'::interval,
-- not as INTERVAL '10 minutes', so regex replacement never matched.
-- This migration rewrites the function directly with:
--   - 2-hour order expiry
--   - p_payment_method parameter
--   - pickup/dropoff addresses in return JSONB
-- ============================================================
