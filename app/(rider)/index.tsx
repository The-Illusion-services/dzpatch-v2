...
export default function RiderHomeScreen() {
  ...
  }, [isOnline, riderId, fetchNearbyOrders]);
  ...
  const formatPrice = useCallback((price: number | null, fallback: number | null) => {
          ...
          >
            <View style={[
              ...
              <Text style={styles.orderPinPrice}>
                {formatPrice(order.dynamic_price, order.suggested_price)}
              </Text>
            </View>
          </Marker>
        ))}
        ...
        >
          ...
          <View style={styles.previewHeader}>
            ...
            <View style={styles.previewPriceBlock}>
              <Text style={styles.previewMetaLabel}>Est. Earnings</Text>
              <Text style={styles.previewPrice}>
                {formatPrice(selectedOrder.dynamic_price, selectedOrder.suggested_price)}
              </Text>
            </View>
          </View>
